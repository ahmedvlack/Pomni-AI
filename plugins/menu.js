...
const CATEGORIES = [
  [1, 'قــــســــم الــتـــحــمــيــل 🪶', 'downloads'],
  [2, 'قــســم الــرومــات 📿', 'group'],
  [3, 'قــســم الـــمــلــصــقــات 🕹', 'sticker'],
  [4, 'قــســم الـمطـور 🛡', 'owner'],
  [5, 'قــســم الــتــجربــه 🌀', 'example'],
  [6, 'قــســم الادوات 👑', 'tools'],
  [7, 'قــســم الــبــحــث 🔍', 'search'],
  [8, 'قــســم الادمــــن 👑', 'admin'],
  [9, 'قــســم الالعـــاب 🔥', 'games'],
  [10, 'قــســم الجــيــف 🖼️', 'gif'],
  [11, 'قــســم اخـــري 👑', 'other']
];
